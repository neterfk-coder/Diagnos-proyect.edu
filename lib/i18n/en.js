const en = {
  ...
  tutor: {
    ...
    recortado: "Long document: only the first part was analysed",
    ...
    errores: {
      ...
      grande: "That PDF is too large. The limit is 12 MB.",
  ...
  paginas: {
    ...
    perfil: {
      ...
      datos: "Your data",
      datosTexto:
        "Your session and language preference are stored only in this browser. Signing out removes them from this device.",
      salir: "Sign out",
      entrar: "Sign in",
      registro: "Create an account",
      aviso:
        "Accounts are not connected to a database yet: this session lives only in your browser.",
    },
  },
