...
export default function Recuperar() {
  ...
  // Cuenta atrás para poder reenviar el enlace
  useEffect(() => {
    if (cuenta <= 0) return;
    ...
    <div className="animate-aparecer">
      ...
      {!enviado ? (
        ...
        <div className="mt-8 animate-aparecer text-center">
          ...
          <h1 className="titulo mt-6 text-3xl font-semibold leading-tight text-tinta">
