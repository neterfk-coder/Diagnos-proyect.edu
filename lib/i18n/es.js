const es = {
  ...
  tutorial: {
    "aria": "Guía de uso de Diagnos",
    "saltar": "Saltar",
    "anterior": "Atrás",
    "siguiente": "Siguiente",
    "empezar": "Empezar",
    "verGuia": "Ver la guía de uso",
    "fichas": [
      {
        "icono": "🎯",
        "etiqueta": "Bienvenida",
        "titulo": "No corrige tu respuesta. Corrige tu razonamiento.",
        "texto": "Otras apps te dicen «incorrecto». Diagnos reconstruye tus pasos, encuentra el punto exacto donde tu lógica se quebró y le pone nombre."
      },
      {
        "icono": "📷",
        "etiqueta": "Paso 1 y 2",
        "titulo": "Muestra cómo lo resolviste",
        "texto": "Haz una foto de tu cuaderno o escribe tus pasos, uno por línea. No importa si está mal: de eso se trata. Verás tu procedimiento con el paso roto marcado."
      },
      {
        "icono": "💬",
        "etiqueta": "Paso 3",
        "titulo": "El tutor solo pregunta",
        "texto": "Nunca te dará la respuesta, y es a propósito. Te hará preguntas hasta que seas tú quien enuncie el error. Ahí es cuando de verdad se aprende."
      },
      {
        "icono": "✅",
        "etiqueta": "Paso 4",
        "titulo": "Demuestra que lo superaste",
        "texto": "Tres ejercicios hechos contra tu error concreto. Lo que cuenta no es acertar, sino no volver a caer en el mismo razonamiento."
      },
      {
        "icono": "🧰",
        "etiqueta": "Herramientas",
        "titulo": "Gráficas y tutor de estudio",
        "texto": "Mueve los parámetros de una función y mira cómo cambia la curva. O sube un PDF y recibe resumen, mapa mental, flashcards y un cuestionario."
      },
      {
        "icono": "🔥",
        "etiqueta": "Tu progreso",
        "titulo": "Racha, puntos y cofres",
        "texto": "Cada actividad suma puntos y mantiene tu racha diaria. Al llenar la barra se abre un cofre con pegatinas. Si eres docente, tendrás el mapa de tu aula."
      }
    ]
  },
  ...
  notificaciones: {
    ...
    vacio: "Nada por aquí todavía. Cuando ganes puntos o desbloquees algo, aparecerá aquí.",
    limpiar: "Limpiar",
    ahora: "ahora mismo",
    hace: "hace",
    puntosTexto: "Sigue así para llenar la barra.",
    cofreTexto: "Ábrelo y llévate una pegatina nueva.",
  },

  racha: {
    aria: "Tu racha diaria",
    titulo: "Racha",
    dia: "día",
    dias: "días",
    seguidos: "seguidos",
    hoyHecho: "Hoy ya cuenta",
    hoyPendiente: "Hoy todavía no cuenta",
    empezar: "Empieza tu racha hoy",
    empezarTexto:
      "Diagnostica un ejercicio, resuelve una práctica o crea material de estudio. Con cualquiera de las tres, el día cuenta.",
    mejor: "Tu mejor racha",
    proximoHito: "Próximo hito",
    enPeligroTitulo: "Tu racha está en juego",
    enPeligroTexto: "Haz una actividad hoy para no perderla.",
    semana: "Esta semana",
    diasCortos: ["D", "L", "M", "X", "J", "V", "S"],

    subeTitulo: "¡Racha de",
    subeTitulo2: "!",
    subeTexto: "Vuelve mañana para que siga creciendo.",
    hitoTexto: "Has llegado a un hito. Eso ya es constancia, no suerte.",
    seguir: "Seguir",
  },

  progreso: {
    etiqueta: "Tu progreso",
    aria: "Progreso y recompensas",
    puntos: "puntos",
    paraCofre: "para el próximo cofre",
    coleccion: "Tu colección",
    de: "de",
    bloqueada: "Sin desbloquear",

    motivos: {
      diagnostico: "Ejercicio diagnosticado",
      descubrimiento: "¡Lo descubriste tú!",
      ejercicioSuperado: "Ejercicio superado",
      bucleCerrado: "Concepción errónea superada",
      materialEstudio: "Material de estudio creado",
    },

    cofreListo: "¡Cofre disponible!",
    cofreAbrir: "Abrir cofre",
    cofreEspera: "Sigue practicando para llenar la barra",
    cofrePendientes: "cofres esperando",

    abriendo: "Abriendo…",
    premioTitulo: "¡Nueva pegatina!",
    premioRepetida: "Ya la tenías, pero sigue quedando bien",
    premioCerrar: "Genial",
    ...
    pegatinas: {
      ...
      "cazador-signos": "Cazador de signos",
      equilibrista: "Equilibrista",
      parentesis: "Domador de paréntesis",
      fraccionario: "Maestro de fracciones",
      socratico: "Socrático",
      insistente: "Insistente",
      lector: "Lector voraz",
      "mente-clara": "Mente clara",
      "sin-red": "Sin red",
      demoledor: "Demoledor de mitos",
      eureka: "¡Eureka!",
    },
  },
  ...
  pie: {
    ...
    producto: {
      ...
      enlaces: [
        ...
        { href: "/grafica", texto: "Laboratorio de funciones" },
  ...
  practica: {
    ...
    faseLeer: "Leyendo el documento",
    faseExtraer: "Extrayendo el texto",
    faseAnalizar: "Analizando el contenido",
    faseRedactar: "Redactando tu material",
    resumenBreve: "En breve",
    resumenCompleto: "Completo",
    pestanaMapa: "Mapa mental",
    pestanaQuiz: "Cuestionario",
    mapaAyuda: "Pasa el cursor por una rama para destacarla.",
    aciertos: "aciertos",
    quizPerfecto: "Perfecto. Has entendido el documento, no memorizado respuestas.",
    quizBien: "Vas bien. Repasa las que fallaste y vuelve a intentarlo.",
    quizRepasa: "Conviene releer el resumen antes de volver a intentarlo.",
    quizReiniciar: "Intentar de nuevo",
    ...
    // Cierre del bucle: resolver, comprobar y superar
    resolver: "Resolver",
    ocultarResolucion: "Ocultar",
    tuRespuesta: "Tu procedimiento",
    marcadorRespuesta: "Escribe tus pasos aquí, uno por línea",
    comprobar: "Comprobar",
    comprobando: "Comprobando…",
    errorComprobar: "No se pudo comprobar tu respuesta. Inténtalo de nuevo.",
    superado: "Superado",
    reincidido: "Vuelve a intentarlo",
    progreso: "superados",
    reintentar: "Intentar otra vez",
    cerradoTitulo: "Has superado esta concepción errónea",
    cerradoTexto:
      "Resolviste los tres ejercicios sin volver a caer en el mismo razonamiento. Eso es lo que significa haberlo entendido, no haber acertado.",
    parcialTitulo: "Vas por buen camino",
    parcialTexto:
      "Termina los ejercicios que quedan para confirmar que la idea está asentada.",
  },
  ...
  docente: {
    ...
    casos: "casos",
    superadas: "superadas",
    superadasTitulo: "Concepciones superadas",
    superadasTexto: "Veces que un estudiante completó la práctica sin recaer.",
    ...
    // Acceso restringido
    entrarTitulo: "Este panel es para docentes",
    entrarTexto:
      "Inicia sesión con tu cuenta de docente para ver el mapa de tu aula. Los datos son anónimos y agregados: nunca se muestra a un estudiante concreto.",
    entrarBoton: "Iniciar sesión",
    registroBoton: "Crear cuenta de docente",
    soloDocentesTitulo: "Tu cuenta es de estudiante",
    soloDocentesTexto:
      "El panel de aula solo lo ven las cuentas de docente. Puedes cambiar el rol de tu cuenta desde tu perfil.",
    irAlPerfil: "Ir a mi perfil",

    // Código de aula
    codigoEtiqueta: "Código de tu aula",
    codigoTexto:
      "Compártelo con tus estudiantes. Los diagnósticos de quien lo introduzca aparecerán aquí.",
    copiar: "Copiar",
    copiado: "Copiado",
    sinDatosTitulo: "Todavía no hay diagnósticos",
    sinDatosTexto:
      "En cuanto un estudiante de tu aula analice un ejercicio, su concepción errónea aparecerá en este mapa.",
    errorCarga: "No se pudo cargar el aula. Recarga la página.",
  },

  grafica: {
    etiqueta: "Laboratorio de funciones",
    titulo: "Mira cómo se ve realmente la función",
    entrada:
      "Elige una función, mueve los parámetros y observa qué le pasa a la curva. Entender una fracción o una ecuación se vuelve mucho más fácil cuando puedes verla cambiar.",

    familias: {
      trigonometrica: "Trigonométricas",
      algebraica: "Algebraicas",
    },

    parametros: "Parámetros",
    ayudaParametros:
      "Mueve cada control y fíjate en qué cambia. Es la forma más rápida de entender qué hace cada número.",

    a: "Amplitud",
    aTexto: "Estira o aplasta la curva en vertical. Si es negativo, la voltea.",
    b: "Frecuencia",
    bTexto: "Comprime o alarga la curva en horizontal. Cambia el periodo.",
    c: "Desplazamiento horizontal",
    cTexto: "Mueve la curva a izquierda o derecha.",
    d: "Desplazamiento vertical",
    dTexto: "Sube o baja la curva entera.",
    ...
    asintotas: "Las líneas naranjas discontinuas son asíntotas: ahí la función no existe.",
    pistaCursor: "Pasa el cursor por la gráfica para leer sus valores.",

    notas: {
      tan: "La tangente se dispara al infinito cada π: por eso aparece cortada en ramas.",
      sec: "La secante es 1/cos, así que no existe donde el coseno vale cero.",
      csc: "La cosecante es 1/sen, así que no existe donde el seno vale cero.",
      cot: "La cotangente es cos/sen, así que no existe donde el seno vale cero.",
      inversa: "1/x nunca toca el cero: se acerca infinitamente a los dos ejes.",
      raiz: "La raíz cuadrada no existe para números negativos: la curva empieza en cero.",
      logaritmo: "El logaritmo solo existe para valores positivos.",
    },
  },
  ...
  tutor: {
    ...
    limite: "PDF con texto seleccionable",
    leyendoPdf: "Leyendo el PDF…",
    ...
    errores: {
      ...
      grande:
        "No se pudo leer ese PDF en el navegador y pesa demasiado para subirlo. Copia el texto y pégalo aquí abajo.",
  ...
  paginas: {
    ...
    ayuda: {
      ...
      referencias: {
        titulo: "Referencias",
        entrada: "Las fuentes en las que se apoya el catálogo. Cada concepción errónea remite al trabajo donde está documentada, para que puedas comprobarlo por tu cuenta.",
      },
    ...
    contacto: {
      ...
      formulario: {
        ...
        errorEnvio: "No se pudo enviar el mensaje. Inténtalo de nuevo en un momento.",
    ...
    perfil: {
      ...
      personalizar: "Personaliza tu perfil",
      personalizarTexto: "Tu foto, tu color y una descripción. Solo tú lo ves, pero se nota.",
      avatarSubir: "Subir foto",
      avatarCambiar: "Cambiar foto",
      avatarQuitar: "Quitar",
      avatarError: "No se pudo leer esa imagen. Prueba con otra.",
      color: "Color del perfil",
      bio: "Descripción",
      bioMarcador: "Cuenta algo sobre ti: qué estudias, qué se te resiste…",
      guardar: "Guardar cambios",
      guardando: "Guardando…",
      guardado: "Guardado",
      guardarError: "No se pudieron guardar los cambios. Inténtalo de nuevo.",
      rachaActual: "Racha actual",
      rachaMejor: "Mejor racha",
      pegatinas: "Pegatinas",

      aulaTitulo: "Aula",
      aulaDocenteTexto:
        "Este es el código de tu aula. Dáselo a tus estudiantes para que sus diagnósticos aparezcan en tu panel.",
      aulaEstudianteTexto:
        "Si tu docente te ha dado un código de aula, escríbelo aquí. Tus diagnósticos se sumarán a su mapa de clase, siempre de forma anónima.",
      aulaCampo: "Código de aula",
      aulaGuardar: "Guardar",
      aulaGuardando: "Guardando…",
      aulaGuardada: "Guardado",
      aulaSalir: "Salir del aula",
      sinAula: "No perteneces a ningún aula.",

      rolTitulo: "Tipo de cuenta",
      rolTexto:
        "Cambia a docente si necesitas ver el mapa de un aula: hace falta el código que reparte tu centro. Volver a estudiante no lo necesita.",
      rolGuardado: "Rol actualizado",
      codigoDocenteCampo: "Código de docente",
      codigoDocenteBoton: "Confirmar",
      codigoDocenteCancelar: "Cancelar",
      codigoDocenteError: "Ese código no es válido.",
      codigoDocenteCargando: "Comprobando…",
    },
  },
  ...
  acceso: {
    ...
    errores: {
      ...
      codigoDocenteInvalido:
        "Tu cuenta se creó, pero ese código de docente no era válido: te unes como estudiante. Puedes añadirlo después desde tu perfil.",
    },
