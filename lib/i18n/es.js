const es = {
  ...
  tutor: {
    ...
    recortado: "Documento largo: solo se analizó la primera parte",
  ...
  paginas: {
    ...
    perfil: {
      ...
      datos: "Tus datos",
      datosTexto:
        "Tu sesión y tu preferencia de idioma se guardan solo en este navegador. Al cerrar sesión se eliminan de este dispositivo.",
      salir: "Cerrar sesión",
      entrar: "Iniciar sesión",
      registro: "Crear una cuenta",
      aviso:
        "Las cuentas todavía no están conectadas a una base de datos: esta sesión vive solo en tu navegador.",
    },
  },
