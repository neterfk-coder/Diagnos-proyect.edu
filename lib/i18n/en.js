const en = {
  ...
  tutorial: {
    "aria": "How to use Diagnos",
    "saltar": "Skip",
    "anterior": "Back",
    "siguiente": "Next",
    "empezar": "Start",
    "verGuia": "View the walkthrough",
    "fichas": [
      {
        "icono": "🎯",
        "etiqueta": "Welcome",
        "titulo": "It doesn't correct your answer. It corrects your reasoning.",
        "texto": "Other apps just say «incorrect». Diagnos rebuilds your steps, finds the exact point where your logic broke, and gives it a name."
      },
      {
        "icono": "📷",
        "etiqueta": "Steps 1 and 2",
        "titulo": "Show how you solved it",
        "texto": "Photograph your notebook or type your steps, one per line. It does not matter if it is wrong — that is the whole point. You will see your work with the broken step marked."
      },
      {
        "icono": "💬",
        "etiqueta": "Step 3",
        "titulo": "The tutor only asks",
        "texto": "It will never give you the answer, and that is deliberate. It asks questions until you are the one who states the error. That is when you actually learn it."
      },
      {
        "icono": "✅",
        "etiqueta": "Step 4",
        "titulo": "Prove you overcame it",
        "texto": "Three exercises built against your specific error. What counts is not getting it right, but not falling into the same reasoning again."
      },
      {
        "icono": "🧰",
        "etiqueta": "Tools",
        "titulo": "Graphs and the study tutor",
        "texto": "Move a function’s parameters and watch the curve change. Or upload a PDF and get a summary, a mind map, flashcards and a quiz."
      },
      {
        "icono": "🔥",
        "etiqueta": "Your progress",
        "titulo": "Streak, points and chests",
        "texto": "Every activity earns points and keeps your daily streak alive. Filling the bar opens a chest with stickers. If you are a teacher, you get your classroom map."
      }
    ]
  },
  ...
  notificaciones: {
    ...
    vacio: "Nothing here yet. When you earn points or unlock something, it will show up here.",
    limpiar: "Clear",
    ahora: "just now",
    hace: "",
    puntosTexto: "Keep going to fill the bar.",
    cofreTexto: "Open it and claim a new sticker.",
  },
  ...
  practica: {
    ...
    faseLeer: "Reading the document",
    faseExtraer: "Extracting the text",
    faseAnalizar: "Analysing the content",
    faseRedactar: "Writing your material",
    resumenBreve: "Short",
    resumenCompleto: "Full",
    pestanaMapa: "Mind map",
    pestanaQuiz: "Quiz",
    mapaAyuda: "Hover a branch to highlight it.",
    aciertos: "correct",
    quizPerfecto: "Perfect. You understood the document, not memorised answers.",
    quizBien: "Good going. Review the ones you missed and try again.",
    quizRepasa: "Worth rereading the summary before trying again.",
    quizReiniciar: "Try again",
  ...
  docente: {
    ...
    casos: "cases",
    superadas: "overcome",
    superadasTitulo: "Misconceptions overcome",
    superadasTexto: "Times a student finished the practice without relapsing.",
  ...
  paginas: {
    ...
    ayuda: {
      ...
      referencias: {
        titulo: "References",
        entrada: "The sources the catalogue rests on. Every misconception points to the work where it is documented, so you can check it yourself.",
      },
    ...
    contacto: {
      ...
      formulario: {
        ...
        errorEnvio: "The message could not be sent. Please try again in a moment.",
    ...
    perfil: {
      ...
      personalizar: "Personalise your profile",
      personalizarTexto: "Your photo, your colour and a short description. Only you see it, but it shows.",
      avatarSubir: "Upload photo",
      avatarCambiar: "Change photo",
      avatarQuitar: "Remove",
      avatarError: "That image could not be read. Try another one.",
      color: "Profile colour",
      bio: "Description",
      bioMarcador: "Say something about yourself: what you study, what you find hard…",
      guardar: "Save changes",
      guardando: "Saving…",
      guardado: "Saved",
      guardarError: "The changes could not be saved. Please try again.",
      rachaActual: "Current streak",
      rachaMejor: "Best streak",
      pegatinas: "Stickers",
      ...
      rolTexto:
        "Switch to teacher if you need to see a classroom map: it takes the code your school gives out. Switching back to student needs no code.",
      rolGuardado: "Role updated",
      codigoDocenteCampo: "Teacher code",
      codigoDocenteBoton: "Confirm",
      codigoDocenteCancelar: "Cancel",
      codigoDocenteError: "That code isn't valid.",
      codigoDocenteCargando: "Checking…",
    },
  },
  ...
  acceso: {
    ...
    errores: {
      ...
      codigoDocenteInvalido:
        "Your account was created, but that teacher code wasn't valid — you're joining as a student. You can add it later from your profile.",
    },
